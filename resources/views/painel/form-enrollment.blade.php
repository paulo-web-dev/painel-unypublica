    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="col-span-12 box lg:col-span-8 xxl:col-span-9 tab-content">
            ...
            <div id="informacoes-matricula" role="tabpanel" aria-labelledby="informacoes-pessoais-tab"
                ...
                <form action="{{ route('cadastrar-matricula') }}"
                    ...
                    <div class="intro-y col-span-12 xxl:col-span-6">
                        <div class="col-span-12 mt-10 ml-3">
                        ...
                        <div class="flex mt-10 ml-0">
                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                ...
                                <input id="valor" type="text" name="valor" class="form-control"
                                    placeholder="Valor da Matrícula" value="">
                            </div>
                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                ...
                                <input id="desconto" type="text" name="desconto" class="form-control"
                                    placeholder="Desconto da Matrícula" value="">
                            </div>
                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                ...
                                <input id="valorFinal" type="text" name="valorFinal" class="form-control"
                                    placeholder="Valor Final da Matrícula" value="">
                            </div>
                        </div>
                        <div class="flex mt-10 ml-0">
                            ...
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                <label for="dataPagamento" class="form-label"><strong>Data de Pagamento</strong></label>
                                <div class="relative mx-auto">
                                    <div class="absolute rounded-l w-10 h-full flex items-center justify-center bg-gray-100 border
                                                                    text-gray-600 dark:bg-dark-1 dark:border-dark-4">
                                        <i data-feather="calendar" class="w-4 h-4"></i>
                                    </div>
                                    <input type="text" autocomplete="off" class="data form-control pl-12"
                                        name="dataPagamento" value="" data-single-mode="true">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="intro-y box col-span-12 xxl:col-span-6">
                        ...
                        <div class="flex mt-10 ml-0">
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input id="linkPagamento" type="text" name="linkPagamento" class="form-control" value="">
                            </div>
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
