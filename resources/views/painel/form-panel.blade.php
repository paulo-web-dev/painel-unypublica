...
@section('content')
    <form action="{{ route('cadastrar-painel') }}" enctype="multipart/form-data"
            ...
            <div class="col-span-12 lg:col-span-4">
                <div class="intro-y box mt-5 p-5">
                    ...
                    @if ($class->unyflex==1)
                      ...
                      <div class="mt-3">
                                    <label for="update-profile-form-7"
                                        class="form-label"><strong>Link Da Aula</strong></label>
                                    <input id="update-profile-form-7" type="text" name="link" class="form-control"
                                        placeholder="Link Da Aula" >
                                </div>
                         <div class="mt-3">
                                    <label for="update-profile-form-7"
                                        class="form-label"><strong>Link de Degustação</strong></label>
                                    <input id="update-profile-form-7" type="text" name="degustacao" class="form-control"
                                        placeholder="Link de Degustação" >
                                </div>
                         ...
                         <div class="mt-3">
                                ...
                                <input type="hidden" name="unyflex" value="{{$class->unyflex}}">
                                @endif
                </div>
            </div>
